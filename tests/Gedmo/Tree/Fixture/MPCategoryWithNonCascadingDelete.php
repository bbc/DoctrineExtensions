 ...
 */
class MPCategoryWithNonCascadingDelete
{
    /**
    ...
    /**
     * @Gedmo\TreeParent
     * @ORM\ManyToOne(targetEntity="MPCategoryWithNonCascadingDelete", inversedBy="children")
     * @ORM\JoinColumns({
    ...
    public function setParent(MPCategoryWithNonCascadingDelete $parent = null)
    {
